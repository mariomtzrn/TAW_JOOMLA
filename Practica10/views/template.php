...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>SI</b>IT</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SI</b>it</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                 <?php echo $_SESSION["nombre"]; ?> <?php echo $_SESSION["apellido"]; ?> - <?php echo $tipo; ?>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
                <div class="pull-left">
                  <a href="index.php?action=Perfil&id=<?php echo $_SESSION["id"]; ?>&select=Tutor" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="index.php?action=log_out" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
