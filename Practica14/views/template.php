...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="views/assets/css/datatables/datatables.min.css">
                        ...
                        <div class="navbar-header">
                            <a href="db-default.html" class="navbar-brand">
                                <div class="brand-image brand-big">
                                    <img src="views/assets/img/logo-big.png" alt="logo" class="logo-big">
                                </div>
                                <div class="brand-image brand-small">
                                    <img src="views/assets/img/logo.png" alt="logo" class="logo-small">
                                </div>
                            </a>
                            <!-- Toggle Button -->
                        ...
                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center pull-right">
                            ...
                            <li class="nav-item dropdown"><a id="user" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><img src="views/assets/img/avatar/avatar-01.jpg" alt="..." class="avatar rounded-circle"></a>
                                <ul aria-labelledby="user" class="user-size dropdown-menu">
                                    ...
                                    <li>
                                        <a href="index.php?action=Perfil&id=<?php echo $_SESSION["id"]?>" class="dropdown-item"> 
                                            Profile
                                        </a>
                                    </li>
                                    <li><a rel="nofollow" href="index.php?action=log_out" class="dropdown-item logout text-center"><i class="ti-power-off"></i></a></li>
                                </ul>
                            </li>
                            <!-- End User -->
                            <!-- Begin Quick Actions -->
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane show active fade" id="messenger" aria-labelledby="messenger-tab">
                                        ...
                                        <div class="messenger-message messenger-message-sender">
                                            <img class="messenger-image messenger-image-default" src="views/assets/img/avatar/avatar-02.jpg" alt="...">
                                        ...
                                        <div class="messenger-message messenger-message-sender">
                                            <img class="messenger-image messenger-image-default" src="views/assets/img/avatar/avatar-05.jpg" alt="...">
                                            <div class="messenger-message-wrapper">
                                                <div class="messenger-message-content">
                                                    <p>
...
function validarC() {
    ...
    if(pass!=re_pass){
      ...
      document.getElementById("demo").innerHTML = "Contraseña no coincide";
      document.getElementById("validacion").value=0;
    }else{
      document.getElementById("demo").innerHTML = "";
      document.getElementById("demo2").innerHTML = "Contraseña coincide";
  ...
  function  url(id_op){
    var id=id_op;
    location.href="index.php?action=usuarios&id="+id;
  }
